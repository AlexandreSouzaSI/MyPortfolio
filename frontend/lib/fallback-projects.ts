...
// Mesmo conteúdo do seed do backend (prisma/seed.ts). Usado só se a API
// não responder (ex: site publicado antes do backend estar no ar) — assim
// a página nunca fica em branco. Quando o backend estiver rodando, os
// dados de verdade (editáveis via API) sobrescrevem isso automaticamente.
export const fallbackProjects: Project[] = [
    ...
    },
    {
        ...
        techStack: ['NestJS', 'Prisma', 'PostgreSQL', 'React', 'Leaflet', 'TypeScript'],
